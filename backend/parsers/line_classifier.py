...
class LineClassifier:
    ...
    # Patrón para TOTAL con código explícito: "TOTAL SUBCAPÍTULO 01.04.01  12.345,67" o "TOTAL SUBCAPÍTULO C08.01..."
    # Acepta códigos numéricos (01.04.01) y alfanuméricos (C08.01, C08, etc.)
    PATRON_TOTAL = re.compile(r'^TOTAL\s+(SUBCAPÍTULO|CAPÍTULO|APARTADO)\s+([A-Z0-9][\w\.]*)', re.IGNORECASE)
    ...
    def clasificar(cls, linea: str, contexto: Optional[Dict] = None) -> Dict:
        ...
        if numeros_match:
            ...
            # IMPORTANTE: Verificar primero si es una línea TOTAL (que también tiene números)
