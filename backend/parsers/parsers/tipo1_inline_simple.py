"""
Parser V2 Tipo 1: Datos Inline + Sin Descompuestos
===================================================

Sistema de 4 Fases para documentos con:
- Datos numéricos (CANT/PRECIO/IMPORTE) en la MISMA LÍNEA que el código
- Sin descompuestos
- 1 o 2 columnas (normalizadas por ColumnDetector)

TIPO 1: PROYECTO 7 y similares - Datos inline en formato:
  CODIGO UNIDAD RESUMEN CANTIDAD PRECIO IMPORTE
...
# Importar componentes del parser_v2
...
class ParserV2_Tipo1_InlineSimple(BaseParserV2):
    """
    Parser TIPO 1: Datos Inline + Sin Descompuestos

    Documentos con:
    - Datos numéricos en la MISMA LÍNEA que el código
    - Sin descompuestos
    - 1 o 2 columnas (ya normalizadas)

    Ejemplo: Proyecto 7 y otros con formato:
      m23U01C190 Ud DESMONTAJE DE PAPELERA 9,00 26,89 242,01
    """

    def __init__(self, pdf_path: str, user_id: int, proyecto_id: int):
        # Llamar constructor de clase base
        super().__init__(pdf_path, user_id, proyecto_id)
